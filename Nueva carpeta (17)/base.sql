...
-- Tiempo de generación: 26-09-2018 a las 23:53:44
...
--
-- Estructura de tabla para la tabla `kqsp6_assets`
--

DROP TABLE IF EXISTS `kqsp6_assets`;
CREATE TABLE IF NOT EXISTS `kqsp6_assets` (
...
--
-- Volcado de datos para la tabla `kqsp6_assets`
--

INSERT INTO `kqsp6_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Estructura de tabla para la tabla `kqsp6_associations`
--

DROP TABLE IF EXISTS `kqsp6_associations`;
CREATE TABLE IF NOT EXISTS `kqsp6_associations` (
...
--
-- Estructura de tabla para la tabla `kqsp6_banners`
--

DROP TABLE IF EXISTS `kqsp6_banners`;
CREATE TABLE IF NOT EXISTS `kqsp6_banners` (
...
--
-- Estructura de tabla para la tabla `kqsp6_banner_clients`
--

DROP TABLE IF EXISTS `kqsp6_banner_clients`;
CREATE TABLE IF NOT EXISTS `kqsp6_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `kqsp6_banner_tracks`
--

DROP TABLE IF EXISTS `kqsp6_banner_tracks`;
CREATE TABLE IF NOT EXISTS `kqsp6_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `kqsp6_categories`
--

DROP TABLE IF EXISTS `kqsp6_categories`;
CREATE TABLE IF NOT EXISTS `kqsp6_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `kqsp6_categories`
--

INSERT INTO `kqsp6_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 424, '2018-09-26 01:42:51', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 424, '2018-09-26 01:42:51', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\",\"foobar\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 424, '2018-09-26 01:42:51', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 424, '2018-09-26 01:42:51', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 424, '2018-09-26 01:42:51', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"target\":\"\",\"image\":\"\"}', '', '', '{\"page_title\":\"\",\"author\":\"\",\"robots\":\"\"}', 424, '2018-09-26 01:42:51', 0, '0000-00-00 00:00:00', 0, '*', 1),
(8, 36, 1, 11, 12, 1, 'news', 'com_content', 'News', 'news', '', '<p>This is the latest news from us.</p><p>You can edit this description in the Content Category Manager.</p><p>This will show the most recent article. You can easily change it to show more if you wish.</p>', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 424, '2018-09-26 01:42:51', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kqsp6_contact_details`
--

DROP TABLE IF EXISTS `kqsp6_contact_details`;
CREATE TABLE IF NOT EXISTS `kqsp6_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `kqsp6_content_frontpage`
--

DROP TABLE IF EXISTS `kqsp6_content_frontpage`;
CREATE TABLE IF NOT EXISTS `kqsp6_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `kqsp6_content_rating`
--

DROP TABLE IF EXISTS `kqsp6_content_rating`;
CREATE TABLE IF NOT EXISTS `kqsp6_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `kqsp6_content_types`
--

DROP TABLE IF EXISTS `kqsp6_content_types`;
CREATE TABLE IF NOT EXISTS `kqsp6_content_types` (
...
--
-- Volcado de datos para la tabla `kqsp6_content_types`
--

INSERT INTO `kqsp6_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `kqsp6_core_log_searches`
--

DROP TABLE IF EXISTS `kqsp6_core_log_searches`;
CREATE TABLE IF NOT EXISTS `kqsp6_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `kqsp6_extensions`
--

DROP TABLE IF EXISTS `kqsp6_extensions`;
CREATE TABLE IF NOT EXISTS `kqsp6_extensions` (
...
--
-- Volcado de datos para la tabla `kqsp6_extensions`
--

INSERT INTO `kqsp6_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"81693e07c6a32b1bbfddd1492cd8ba50\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1537973602}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 0, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_stats\",\"type\":\"plugin\",\"creationDate\":\"November 2013\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_STATS_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"stats\"}', '{\"mode\":2,\"lastrun\":1537926216,\"unique_id\":\"a6906c6bc391a531cde79161b9a73d13df20aef6\",\"interval\":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estructura de tabla para la tabla `kqsp6_fields`
--

DROP TABLE IF EXISTS `kqsp6_fields`;
CREATE TABLE IF NOT EXISTS `kqsp6_fields` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `kqsp6_fields_categories`
--

DROP TABLE IF EXISTS `kqsp6_fields_categories`;
CREATE TABLE IF NOT EXISTS `kqsp6_fields_categories` (
...
--
-- Estructura de tabla para la tabla `kqsp6_fields_groups`
--

DROP TABLE IF EXISTS `kqsp6_fields_groups`;
CREATE TABLE IF NOT EXISTS `kqsp6_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `kqsp6_fields_values`
--

DROP TABLE IF EXISTS `kqsp6_fields_values`;
CREATE TABLE IF NOT EXISTS `kqsp6_fields_values` (
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_filters`
--

DROP TABLE IF EXISTS `kqsp6_finder_filters`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_filters` (
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links`
--

DROP TABLE IF EXISTS `kqsp6_finder_links`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links` (
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_terms0`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_terms0`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_terms0` (
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_terms1`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_terms1`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_terms2`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_terms2`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_terms3`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_terms3`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_terms4`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_terms4`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_terms5`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_terms5`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_terms6`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_terms6`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_terms7`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_terms7`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_terms8`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_terms8`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_terms9`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_terms9`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_termsa`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_termsa`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_termsb`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_termsb`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_termsc`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_termsc`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_termsd`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_termsd`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_termse`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_termse`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_links_termsf`
--

DROP TABLE IF EXISTS `kqsp6_finder_links_termsf`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_taxonomy`
--

DROP TABLE IF EXISTS `kqsp6_finder_taxonomy`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `kqsp6_finder_taxonomy`
--

INSERT INTO `kqsp6_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kqsp6_finder_taxonomy_map`
--

DROP TABLE IF EXISTS `kqsp6_finder_taxonomy_map`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_terms`
--

DROP TABLE IF EXISTS `kqsp6_finder_terms`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_terms` (
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_terms_common`
--

DROP TABLE IF EXISTS `kqsp6_finder_terms_common`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Volcado de datos para la tabla `kqsp6_finder_terms_common`
--

INSERT INTO `kqsp6_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_tokens`
--

DROP TABLE IF EXISTS `kqsp6_finder_tokens`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_tokens_aggregate`
--

DROP TABLE IF EXISTS `kqsp6_finder_tokens_aggregate`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `kqsp6_finder_types`
--

DROP TABLE IF EXISTS `kqsp6_finder_types`;
CREATE TABLE IF NOT EXISTS `kqsp6_finder_types` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `kqsp6_languages`
--

DROP TABLE IF EXISTS `kqsp6_languages`;
CREATE TABLE IF NOT EXISTS `kqsp6_languages` (
...
--
-- Volcado de datos para la tabla `kqsp6_languages`
--

INSERT INTO `kqsp6_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kqsp6_menu`
--

DROP TABLE IF EXISTS `kqsp6_menu`;
CREATE TABLE IF NOT EXISTS `kqsp6_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `kqsp6_menu`
--

INSERT INTO `kqsp6_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Estructura de tabla para la tabla `kqsp6_menu_types`
--

DROP TABLE IF EXISTS `kqsp6_menu_types`;
CREATE TABLE IF NOT EXISTS `kqsp6_menu_types` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `kqsp6_menu_types`
--

INSERT INTO `kqsp6_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kqsp6_messages`
--

DROP TABLE IF EXISTS `kqsp6_messages`;
CREATE TABLE IF NOT EXISTS `kqsp6_messages` (
...
--
-- Estructura de tabla para la tabla `kqsp6_messages_cfg`
--

DROP TABLE IF EXISTS `kqsp6_messages_cfg`;
CREATE TABLE IF NOT EXISTS `kqsp6_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `kqsp6_modules`
--

DROP TABLE IF EXISTS `kqsp6_modules`;
CREATE TABLE IF NOT EXISTS `kqsp6_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `kqsp6_modules`
--

INSERT INTO `kqsp6_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Estructura de tabla para la tabla `kqsp6_modules_menu`
--

DROP TABLE IF EXISTS `kqsp6_modules_menu`;
CREATE TABLE IF NOT EXISTS `kqsp6_modules_menu` (
...
--
-- Volcado de datos para la tabla `kqsp6_modules_menu`
--

INSERT INTO `kqsp6_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `kqsp6_newsfeeds`
--

DROP TABLE IF EXISTS `kqsp6_newsfeeds`;
CREATE TABLE IF NOT EXISTS `kqsp6_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `kqsp6_overrider`
--

DROP TABLE IF EXISTS `kqsp6_overrider`;
CREATE TABLE IF NOT EXISTS `kqsp6_overrider` (
...
--
-- Estructura de tabla para la tabla `kqsp6_postinstall_messages`
--

DROP TABLE IF EXISTS `kqsp6_postinstall_messages`;
CREATE TABLE IF NOT EXISTS `kqsp6_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `kqsp6_postinstall_messages`
--

INSERT INTO `kqsp6_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `kqsp6_redirect_links`
--

DROP TABLE IF EXISTS `kqsp6_redirect_links`;
CREATE TABLE IF NOT EXISTS `kqsp6_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `kqsp6_schemas`
--

DROP TABLE IF EXISTS `kqsp6_schemas`;
CREATE TABLE IF NOT EXISTS `kqsp6_schemas` (
...
--
-- Volcado de datos para la tabla `kqsp6_schemas`
--

INSERT INTO `kqsp6_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.8.9-2018-06-19');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kqsp6_session`
--

DROP TABLE IF EXISTS `kqsp6_session`;
CREATE TABLE IF NOT EXISTS `kqsp6_session` (
...
--
-- Volcado de datos para la tabla `kqsp6_session`
--

INSERT INTO `kqsp6_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('apegrsalp706q6bd68fbob3d5s', 0, 0, '1537976130', 'joomla|s:952:\"\";', 424, 'Tadeo'),
('b4vum4q69k3n2q52nj3k815oc2', 1, 0, '1537926218', 'joomla|s:868:\"\";', 424, 'Tadeo'),
('gg1938j52jc9i6o2vvkt9a8qjb', 0, 1, '1537973605', 'joomla|s:736:\"\";', 0, ''),
('qdjoak63osl4aa4k6ucgih70u8', 0, 1, '1537928423', 'joomla|s:596:\"\";', 0, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kqsp6_tags`
--

DROP TABLE IF EXISTS `kqsp6_tags`;
CREATE TABLE IF NOT EXISTS `kqsp6_tags` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `kqsp6_tags`
--

INSERT INTO `kqsp6_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 424, '2018-09-26 01:42:51', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kqsp6_template_styles`
--

DROP TABLE IF EXISTS `kqsp6_template_styles`;
CREATE TABLE IF NOT EXISTS `kqsp6_template_styles` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `kqsp6_template_styles`
--

INSERT INTO `kqsp6_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Estructura de tabla para la tabla `kqsp6_ucm_base`
--

DROP TABLE IF EXISTS `kqsp6_ucm_base`;
CREATE TABLE IF NOT EXISTS `kqsp6_ucm_base` (
...
--
-- Estructura de tabla para la tabla `kqsp6_ucm_content`
--

DROP TABLE IF EXISTS `kqsp6_ucm_content`;
CREATE TABLE IF NOT EXISTS `kqsp6_ucm_content` (
...
--
-- Estructura de tabla para la tabla `kqsp6_ucm_history`
--

DROP TABLE IF EXISTS `kqsp6_ucm_history`;
CREATE TABLE IF NOT EXISTS `kqsp6_ucm_history` (
...
--
-- Estructura de tabla para la tabla `kqsp6_updates`
--

DROP TABLE IF EXISTS `kqsp6_updates`;
CREATE TABLE IF NOT EXISTS `kqsp6_updates` (
...
--
-- Volcado de datos para la tabla `kqsp6_updates`
--

INSERT INTO `kqsp6_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 2, 0, 'Georgian', '', 'pkg_ka-GE', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/ka-GE_details.xml', '', ''),
(2, 2, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.8.11.1', '', 'https://update.joomla.org/language/details3/el-GR_details.xml', '', ''),
(3, 2, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/ja-JP_details.xml', '', ''),
(4, 2, 0, 'Hebrew', '', 'pkg_he-IL', 'package', '', 0, '3.1.1.2', '', 'https://update.joomla.org/language/details3/he-IL_details.xml', '', ''),
(5, 2, 0, 'Bengali', '', 'pkg_bn-BD', 'package', '', 0, '3.8.10.1', '', 'https://update.joomla.org/language/details3/bn-BD_details.xml', '', ''),
(6, 2, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/hu-HU_details.xml', '', ''),
(7, 2, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/af-ZA_details.xml', '', ''),
(8, 2, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/ar-AA_details.xml', '', ''),
(9, 2, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '3.2.1.2', '', 'https://update.joomla.org/language/details3/be-BY_details.xml', '', ''),
(10, 2, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '3.6.5.2', '', 'https://update.joomla.org/language/details3/bg-BG_details.xml', '', ''),
(11, 2, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.8.11.1', '', 'https://update.joomla.org/language/details3/ca-ES_details.xml', '', ''),
(12, 2, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/zh-CN_details.xml', '', ''),
(13, 2, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.8.5.1', '', 'https://update.joomla.org/language/details3/hr-HR_details.xml', '', ''),
(14, 2, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/cs-CZ_details.xml', '', ''),
(15, 2, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.8.11.1', '', 'https://update.joomla.org/language/details3/da-DK_details.xml', '', ''),
(16, 2, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/nl-NL_details.xml', '', ''),
(17, 2, 0, 'Esperanto', '', 'pkg_eo-XX', 'package', '', 0, '3.8.11.1', '', 'https://update.joomla.org/language/details3/eo-XX_details.xml', '', ''),
(18, 2, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.8.10.1', '', 'https://update.joomla.org/language/details3/et-EE_details.xml', '', ''),
(19, 2, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/it-IT_details.xml', '', ''),
(20, 2, 0, 'Khmer', '', 'pkg_km-KH', 'package', '', 0, '3.4.5.1', '', 'https://update.joomla.org/language/details3/km-KH_details.xml', '', ''),
(21, 2, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.8.9.1', '', 'https://update.joomla.org/language/details3/ko-KR_details.xml', '', ''),
(22, 2, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.7.3.1', '', 'https://update.joomla.org/language/details3/lv-LV_details.xml', '', ''),
(23, 2, 0, 'Lithuanian', '', 'pkg_lt-LT', 'package', '', 0, '3.8.10.1', '', 'https://update.joomla.org/language/details3/lt-LT_details.xml', '', ''),
(24, 2, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
(25, 2, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.8.11.1', '', 'https://update.joomla.org/language/details3/nb-NO_details.xml', '', ''),
(26, 2, 0, 'Norwegian Nynorsk', '', 'pkg_nn-NO', 'package', '', 0, '3.4.2.1', '', 'https://update.joomla.org/language/details3/nn-NO_details.xml', '', ''),
(27, 2, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
(28, 2, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.8.11.2', '', 'https://update.joomla.org/language/details3/pl-PL_details.xml', '', ''),
(29, 2, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.8.11.1', '', 'https://update.joomla.org/language/details3/pt-PT_details.xml', '', ''),
(30, 2, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
(31, 2, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/en-AU_details.xml', '', ''),
(32, 2, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(33, 2, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '3.8.12.2', '', 'https://update.joomla.org/language/details3/en-US_details.xml', '', ''),
(34, 2, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
(35, 2, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.4.5.1', '', 'https://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
(36, 2, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(37, 2, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(38, 2, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
(39, 2, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.7.1.1', '', 'https://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
(40, 2, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/ug-CN_details.xml', '', ''),
...
(44, 2, 0, 'German DE', '', 'pkg_de-DE', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(45, 2, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(46, 2, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(47, 2, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.8.12.2', '', 'https://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(48, 2, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(49, 2, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
...
(52, 2, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.8.1.1', '', 'https://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(53, 2, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(54, 2, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.3.1.2', '', 'https://update.joomla.org/language/details3/srp-ME_details.xml', '', ''),
(55, 2, 0, 'English CA', '', 'pkg_en-CA', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/en-CA_details.xml', '', ''),
(56, 2, 0, 'French CA', '', 'pkg_fr-CA', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/fr-CA_details.xml', '', ''),
(57, 2, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '3.8.5.1', '', 'https://update.joomla.org/language/details3/cy-GB_details.xml', '', ''),
...
(61, 2, 0, 'Irish', '', 'pkg_ga-IE', 'package', '', 0, '3.8.7.1', '', 'https://update.joomla.org/language/details3/ga-IE_details.xml', '', ''),
(62, 2, 0, 'Dzongkha', '', 'pkg_dz-BT', 'package', '', 0, '3.6.2.1', '', 'https://update.joomla.org/language/details3/dz-BT_details.xml', '', ''),
(63, 2, 0, 'Slovenian', '', 'pkg_sl-SI', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/sl-SI_details.xml', '', ''),
(64, 2, 0, 'Spanish CO', '', 'pkg_es-CO', 'package', '', 0, '3.8.11.1', '', 'https://update.joomla.org/language/details3/es-CO_details.xml', '', ''),
(65, 2, 0, 'German CH', '', 'pkg_de-CH', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/de-CH_details.xml', '', ''),
(66, 2, 0, 'German AT', '', 'pkg_de-AT', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/de-AT_details.xml', '', ''),
(67, 2, 0, 'German LI', '', 'pkg_de-LI', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/de-LI_details.xml', '', ''),
(68, 2, 0, 'German LU', '', 'pkg_de-LU', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/de-LU_details.xml', '', ''),
(69, 2, 0, 'English NZ', '', 'pkg_en-NZ', 'package', '', 0, '3.8.12.1', '', 'https://update.joomla.org/language/details3/en-NZ_details.xml', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kqsp6_update_sites`
--

DROP TABLE IF EXISTS `kqsp6_update_sites`;
CREATE TABLE IF NOT EXISTS `kqsp6_update_sites` (
...
--
-- Volcado de datos para la tabla `kqsp6_update_sites`
--

INSERT INTO `kqsp6_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1537973605, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1537926218, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1537926218, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kqsp6_update_sites_extensions`
--

DROP TABLE IF EXISTS `kqsp6_update_sites_extensions`;
CREATE TABLE IF NOT EXISTS `kqsp6_update_sites_extensions` (
...
--
-- Volcado de datos para la tabla `kqsp6_update_sites_extensions`
--

INSERT INTO `kqsp6_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(3, 28);
...
--
-- Estructura de tabla para la tabla `kqsp6_usergroups`
--

DROP TABLE IF EXISTS `kqsp6_usergroups`;
CREATE TABLE IF NOT EXISTS `kqsp6_usergroups` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `kqsp6_usergroups`
--

INSERT INTO `kqsp6_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `kqsp6_users`
--

DROP TABLE IF EXISTS `kqsp6_users`;
CREATE TABLE IF NOT EXISTS `kqsp6_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `kqsp6_users`
--

INSERT INTO `kqsp6_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(424, 'Super User', 'Tadeo', 'tadeoxand@gmail.com', '$2y$10$lnr.CCfDG4gfHQHS0giDWe2A1Iwz3JerFiqQVlkOUUPypjV8CMKhq', 0, 1, '2018-09-26 01:42:52', '2018-09-26 15:07:23', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kqsp6_user_keys`
--

DROP TABLE IF EXISTS `kqsp6_user_keys`;
CREATE TABLE IF NOT EXISTS `kqsp6_user_keys` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `kqsp6_user_notes`
--

DROP TABLE IF EXISTS `kqsp6_user_notes`;
CREATE TABLE IF NOT EXISTS `kqsp6_user_notes` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `kqsp6_user_profiles`
--

DROP TABLE IF EXISTS `kqsp6_user_profiles`;
CREATE TABLE IF NOT EXISTS `kqsp6_user_profiles` (
...
--
-- Estructura de tabla para la tabla `kqsp6_user_usergroup_map`
--

DROP TABLE IF EXISTS `kqsp6_user_usergroup_map`;
CREATE TABLE IF NOT EXISTS `kqsp6_user_usergroup_map` (
...
--
-- Volcado de datos para la tabla `kqsp6_user_usergroup_map`
--

INSERT INTO `kqsp6_user_usergroup_map` (`user_id`, `group_id`) VALUES
(424, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kqsp6_utf8_conversion`
--

DROP TABLE IF EXISTS `kqsp6_utf8_conversion`;
CREATE TABLE IF NOT EXISTS `kqsp6_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `kqsp6_utf8_conversion`
--

INSERT INTO `kqsp6_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kqsp6_viewlevels`
--

DROP TABLE IF EXISTS `kqsp6_viewlevels`;
CREATE TABLE IF NOT EXISTS `kqsp6_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Volcado de datos para la tabla `kqsp6_viewlevels`
--

INSERT INTO `kqsp6_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
